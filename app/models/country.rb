    ...
    def all
      {
        ...
        :bo => 'Bolivia, Plurinational State of', :ba => 'Bosnia and Herzegovina', :bw => 'Botswana', :bv => 'Bouvet Island',
        ...
        :co => 'Colombia', :km => 'Comoros', :cg => 'Congo', :cd => 'Congo, Democratic Republic of the', :ck => 'Cook Islands', :cr => 'Costa Rica',
        ...
        :ir => 'Iran, Islamic Republic of', :iq => 'Iraq', :ie => 'Ireland', :il => 'Israel', :it => 'Italy', :jm => 'Jamaica', :jp => 'Japan', :jo => 'Jordan',
        :kz => 'Kazakhstan', :ke => 'Kenya', :ki => 'Kiribati', :kp => 'Korea, Democratic People\'s Republic of', :kr => 'Korea, Republic of', :kw => 'Kuwait',
        :kg => 'Kyrgyzstan', :la => 'Lao People\'s Democratic Republic', :lv => 'Latvia', :lb => 'Lebanon', :ls => 'Lesotho', :lr => 'Liberia', 
        :ly => 'Libyan Arab Jamahiriya', :li => 'Liechtenstein', :lt => 'Lithuania', :lu => 'Luxembourg', :mo => 'Macao', :mk => 'Macedonia', :mg => 'Madagascar',
        :mw => 'Malawi', :my => 'Malaysia', :mv => 'Maldives', :ml => 'Mali', :mt => 'Malta', :mh => 'Marshall Islands', :mq => 'Martinique', :mr => 'Mauritania',
        :mu => 'Mauritius', :yt => 'Mayotte', :mx => 'Mexico', :fm => 'Micronesia, Federated States of', :md => 'Moldova, Republic of', :mc => 'Monaco',
        ...
        :pw => 'Palau', :ps => 'Palestinian Territory', :pa => 'Panama', :pg => 'Papua New Guinea', :py => 'Paraguay', :pe => 'Peru', :ph => 'Philippines',
        :pn => 'Pitcairn', :pl => 'Poland', :pt => 'Portugal', :pr => 'Puerto Rico', :qa => 'Qatar', :re => 'Reunion', :ro => 'Romania', :ru => 'Russian Federation',
        :rw => 'Rwanda', :sh => 'Saint Helena, Ascension and Tristan da Cunha', :kn => 'Saint Kitts and Nevis', :lc => 'Saint Lucia', :pm => 'Saint Pierre and Miquelon',
        ...
        :so => 'Somalia', :za => 'South Africa', :gs => 'South Georgia and the South Sandwich Islands', :es => 'Spain', :lk => 'Sri Lanka', :sd => 'Sudan',
        :sr => 'Suriname', :sj => 'Svalbard and Jan Mayen', :sz => 'Swaziland', :se => 'Sweden', :ch => 'Switzerland', :sy => 'Syrian Arab Republic',
        :tw => 'Taiwan, Province of China', :tj => 'Tajikistan', :tz => 'Tanzania, United Republic of', :th => 'Thailand', :tl => 'Timor-Leste', :tg => 'Togo',
        ...
        :ye => 'Yemen', :zm => 'Zambia', :zw => 'Zimbabwe', :england => 'England', :europeanunion => 'European Union', :catalonia => 'Catalonia',
